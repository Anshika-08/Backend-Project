    ...
    <>
        ...
        <div className='form'>
            ...
            <form onSubmit={handleFetch} >
                <label form="inputName4">Registered Mobile Number</label>
                <div id="fetchBox">
                    <input type="number" name="id" className="form-control" id="id" placeholder="Mobile Number" onChange={onChange2} disabled={false} />
            ...
            <form onSubmit={handleReport}>
                <div className="form-row">
                    ...
                    <label form="inputName4">Name</label>
                    <input type="text" name="Name" id="name" className="form-control" placeholder='Name' onChange={onChange1} disabled/>
                    </div>
                    
                    <div className="form-group col-md-6">
                    <label form="inputName4">Quantity</label>
                    <input type="number" name="success" className="form-control" id="successful"  placeholder="Quantity" onChange={onChange1}/>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-6">
                    <label form="inputName4">House No.</label>
                    <input type="text" name="house" id="house" className="form-control" placeholder='House Number' onChange={onChange1}/>
                    </div>
                    
                    <div className="form-group col-md-6">
                    <label form="inputName4">City</label>
                    <select id="city" name="city" onChange={onChange1} className="form-control">
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" name="others"  placeholder="Enter Your Address"  onChange={onChange1}/>
                </div>
