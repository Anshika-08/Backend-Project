        ...
        <div className='form'>
            ...
            <form onSubmit={handleFetch} className="mainform">
                <div className="form-row">
                    ...
                    <label form="inputName4">Mobile Number *</label>
                    <input type="number" id="id" name="id" className="form-control"  placeholder="Mobile Number" onChange={onChange1}/>
                    </div>
                </div>
                <div className="form-row">
                  
                    <div className="form-group col-md-6">
                    <label form="inputName4">From Date *</label>
                    <input type="date" id="from" name="from" className="form-control"  placeholder="from" onChange={onChange1}/>
                    </div>
                    <div className="form-group col-md-6">
                    <label form="inputPassword4">To Date *</label>
                    <input type="date"id="to" name="to" className="form-control"  placeholder="to" onChange={onChange1} />
                    </div>
                </div>
                <div className="form-row">
