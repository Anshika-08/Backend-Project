        ...
        <div className='form'>
            ...
            <form onSubmit={handleFetch} className="mainform">
                <div className="form-row">
                    ...
                    <input type="date" name="from" id="from" className="form-control"  placeholder="from" onChange={onChange1}/>
                    </div>
                    <div className="form-group col-md-6">
                    <label form="inputPassword4">To Date *</label>
                    <input type="date" name="to" id="to" className="form-control"  placeholder="to" onChange={onChange1} />
                    </div>
                </div>
