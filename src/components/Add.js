      ...
      <div className='form'>
            ...
            <form onSubmit={handleSignup} className="mainform">
                <div className="form-row">
                    ...
                    <label form="inputPassword4">Name *</label>
                    <input type="text" name="Name" className="form-control" id="Name"  placeholder="Name" onChange={onChange1}/>
                    </div>
                    <div className="form-group col-md-6">
                    <label form="inputName4">Mobile Number *</label>
                    <input type="number" name="id" className="form-control" id="id" placeholder="Mobile Number" onChange={onChange1}/>
                    </div>
                </div>
